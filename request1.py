...
# request module ka use isliye krte h kyuki wo send krega http request python is mdd se
with open("courses.json","w") as file:
    # with open ka hum isliye use  krte h direct open ho jaye as file ka use hum it is place of variable
